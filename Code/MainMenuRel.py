...
def LogFrame(Status):
    if Status == 1:
        LogInImage = CTkImage(Image.open("134.jpg"),size = (500,600))
...
SettingsImage = CTkImage(Image.open("settings-icon.png"),size = (30,30))
LogInImageFrame = CTkFrame(master = root)
LogInImage = CTkImage(Image.open("134.jpg"),size = (500,600))
LogInUserImage = CTkImage(Image.open("username-icon.jpg"),size = (30,30))
LogInPassImage = CTkImage(Image.open("password-icon.jpg"),size = (30,30))
LogOutImage = CTkImage(Image.open("log-out-icon.jpg"),size = (30,30))
LogInPageFrame = CTkFrame(master = root, fg_color = "#CAD4E2")
PastRepoImage = CTkImage(Image.open("reports-icon.png"),size = (30,30))
HomeImage = CTkImage(Image.open("home-icon.png"),size = (30,30))
ExitImage = CTkImage(Image.open("exit-icon.png"),size = (30,30))
ArrowImage = CTkImage(Image.open("arrow-icon.png"),size = (55,55))
ProfileImage = CTkImage(Image.open("profile-icon.png"),size = (50,50))
GreenTickImage = CTkImage(Image.open("greentick-icon.png"),size = (15,15))
UserImage = CTkImage(Image.open("user-icon.png"),size = (165,100))
ActiveMonitorImage = CTkImage(Image.open("monitor-active-icon.png"),size = (200,200))
...
InactiveMonitorImage = CTkImage(Image.open("monitor-inactive-icon.png"),size = (200,200))
